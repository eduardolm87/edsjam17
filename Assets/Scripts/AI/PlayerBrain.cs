...
public class PlayerBrain : Brain
{
	...
	void UseSkill(ref PlayerInput input)
	{
		if (input.Fire1Down)
		{
			if (entity.skills[0] != null)
			{
				entity.skills[0].Use(entity, input);
			}
		}

		if (input.Fire2Down)
		{
			if (entity.skills[1] != null)
			{
				entity.skills[1].Use(entity, input);
			}
		}

		if (input.Fire3Down)
		{
			if (entity.skills[2] != null)
			{
				entity.skills[2].Use(entity, input);
			}
		}
	...
	void Jump()
	{
		...
		{
			entity.locomotor.JumpingStartTime = Time.time;	
		}

		entity.locomotor.ApplyJumpForce();
