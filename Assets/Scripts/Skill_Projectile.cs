...
public class Skill_Projectile : Skill
{
	...
	public List<Hitbox.Properties> Properties = new List<Hitbox.Properties>();
	...
	{
		Hitbox.Create(owner, owner.front.position, owner.transform.forward * projectileVelocity, projectileDamage, projectileDestroyInTime, Properties);
